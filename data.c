...
char pieceChar[] = ".PNBRKQpnbrkq.";
char sideChar[] = "wb-";
char fileChar[] = "12345678";
char rankChar[] = "abcdefgh";

int pieceBig[13] = {FALSE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE,
...
int pieceValue[13] = {0, 100, 325, 325, 550, 1000, 50000, 100, 325, 325,
                             550, 1000, 50000};
...
int pieceRookQueen[13] = {FALSE, FALSE, FALSE, FALSE, TRUE, TRUE,
